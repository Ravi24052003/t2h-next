  ...
  const cards = [
    {
      ...
      description: "Marvel at the iconic ancient rock fortress of Sigiriya.",
      image: "/International/sigiriya.jpg",
    },
    {
      id: 2,
      title: "Golden Temple of Dambulla",
      description: "Explore the stunning cave temples of Dambulla.",
      image: "/International/dambulla-temple.jpg",
    },
    {
      id: 3,
      title: "Yala National Park",
      description: "Experience wildlife safaris at Yala National Park.",
      image: "/International/yala-park.jpg",
    },
    {
      id: 4,
      title: "Ella Scenic Beauty",
      description: "Discover the breathtaking views and hikes in Ella.",
      image: "/International/ella.jpg",
    },
  ];

  return (
    <div className="px-4 py-10 bg-pink-100 w-[90%] mx-auto">
      <h2 className="text-3xl font-bold text-left mb-6">Explore Sri Lanka</h2>
