  ...
  const cards = [
    {
      ...
      description: "Sail through tranquil backwaters on a houseboat.",
      image: "/International/alleppey-backwaters.jpg",
    },
    {
      id: 2,
      title: "Munnar Tea Gardens",
      description: "Stroll amidst lush tea plantations in Munnar.",
      image: "/International/munnar-tea-gardens.jpg",
    },
    {
      id: 3,
      title: "Kumarakom",
      description: "Relax in the serene beauty of Vembanad Lake.",
      image: "/International/kumarakom.jpg",
    },
    {
      id: 4,
      title: "Athirappilly Waterfalls",
      description: "Marvel at Kerala's most majestic waterfall.",
      image: "/International/athirappilly-waterfalls.jpg",
    },
  ];

  return (
    <div className="px-4 py-10 bg-pink-100 w-[90%] mx-auto">
      <h2 className="text-3xl font-bold text-left mb-6">Explore Kerala</h2>
