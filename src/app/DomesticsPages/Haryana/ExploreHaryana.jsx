  ...
  const cards = [
    {
      ...
      description: "Explore the diverse birdlife in this serene sanctuary.",
      image: "/Haryana/sultanpur-national-park.jpg",
    },
    {
      id: 2,
      title: "Surajkund Mela",
      description: "Experience the vibrant crafts fair held annually at Surajkund.",
      image: "/Haryana/surajkund-mela.jpg",
    },
    {
      id: 3,
      title: "Brahma Sarovar",
      description: "Visit the sacred and historical Brahma Sarovar in Kurukshetra.",
      image: "/Haryana/brahma-sarovar.jpg",
    },
    {
      id: 4,
      title: "Pinjore Gardens",
      description: "Stroll through the lush and historic Pinjore Mughal Gardens.",
      image: "/Haryana/pinjore-gardens.jpg",
    },
  ];

  return (
    <div className="px-4 py-10 bg-pink-100 w-[100%] md:w-[90%] mx-auto">
      <h2 className="text-3xl font-bold text-left mb-6">Explore Haryana</h2>
