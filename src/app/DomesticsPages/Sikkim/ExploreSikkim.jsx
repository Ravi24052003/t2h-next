  ...
  const cards = [
    {
      id: 1,
      title: "Tsongmo Lake",
      description: "Witness the beauty of this glacial lake surrounded by snow-capped mountains.",
      image: "/Domestic/tsongmo-lake.jpg",
    },
    {
      id: 2,
      title: "Nathula Pass",
      description: "Experience the breathtaking views and the Indo-China border at Nathula Pass.",
      image: "/Domestic/nathula-pass.jpg",
    },
    {
      id: 3,
      title: "Rumtek Monastery",
      description: "Explore the spiritual essence and stunning architecture of Rumtek Monastery.",
      image: "/Domestic/rumtek-monastery.jpg",
    },
    {
      id: 4,
      title: "Yumthang Valley",
      description: "Discover the Valley of Flowers, a paradise for nature lovers.",
      image: "/Domestic/yumthang-valley.jpg",
    },
    {
      id: 5,
      title: "Gangtok Ropeway",
      description: "Enjoy panoramic views of Gangtok and the surrounding landscapes.",
      image: "/Domestic/gangtok-ropeway.jpg",
    },
  ];

  return (
    <div className="px-4 py-10 bg-pink-100 w-[90%] mx-auto">
      <h2 className="text-3xl font-bold text-left mb-6">Explore Sikkim</h2>
