...
export default function FilterGoa() {
  ...
  const itineraryDetails = [
    { day: 1, title: "Arrival in Goa | Relax at the Beach", text: "Arrive in Goa and spend the day relaxing at Calangute or Baga Beach, soaking in the vibrant vibes of the coastline." },
    { day: 2, title: "North Goa Sightseeing Tour", text: "Explore Fort Aguada, Anjuna Beach, Vagator Beach, and the bustling flea markets of North Goa." },
    { day: 3, title: "South Goa Heritage Tour", text: "Visit the Basilica of Bom Jesus, Se Cathedral, and Colva Beach, followed by a peaceful sunset cruise on the Mandovi River." },
    { day: 4, title: "Island Adventure | Dolphin Spotting", text: "Enjoy an exhilarating day with island tours, water sports, and dolphin-spotting excursions." },
    { day: 5, title: "Departure", text: "Bid farewell to Goa with memories of its sun-kissed beaches and vibrant nightlife." },
  ];
    ...
    Adventure: (
      <div>
        <img
          ...
          alt="Adventure in Goa"
          className="rounded-lg w-full h-[300px] mb-4"
        />
        <ul className="list-disc pl-6 space-y-2 text-gray-700">
          <li>Try parasailing, jet skiing, and banana boat rides at Baga Beach.</li>
          <li>Explore Dudhsagar Waterfalls for a nature-packed adventure.</li>
          <li>Scuba diving at Grande Island to witness vibrant marine life.</li>
        </ul>
      </div>
    ),
    "Enquiry Now": (
