  ...
  const cards = [
    {
      id: 1,
      title: "Dal Lake",
      description: "Enjoy a Shikara ride on the serene waters of Dal Lake.",
      image: "/International/dal-lake.jpg",
    },
    {
      id: 2,
      title: "Gulmarg",
      description: "Experience thrilling skiing adventures in Gulmarg.",
      image: "/International/gulmarg.jpg",
    },
    {
      id: 3,
      title: "Pahalgam",
      description: "Relax amidst the lush valleys of Pahalgam.",
      image: "/International/pahalgam.jpg",
    },
    {
      id: 4,
      title: "Sonamarg",
      description: "Explore the picturesque meadows of Sonamarg.",
      image: "/International/sonamarg.jpg",
    },
  ];

  return (
    <div className="px-4 py-10 bg-pink-100 w-[90%] mx-auto">
      <h2 className="text-3xl font-bold text-left mb-6">Explore Kashmir</h2>
